...
function parseInput(rplyToken, inputStr, id) {
	...
	if (trigger.match(/角色創立M/) != null) return exports.Character.CM(mainMsg[1],mainMsg[2]) ;
	if (trigger.match(/角色創立T/) != null) return exports.Character.CT(mainMsg[1],mainMsg[2]) ;
